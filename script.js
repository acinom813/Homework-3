...
function getRandom(arr) {
  ...
  function makePassword()
  {
    ...
    if (password.hasUppercase) {
      possiblePassword = possiblePassword.concat(upercase);
    ...
    if (password.hasSpecialChars) {
        possiblePassword = possiblePassword.concat(specialChars);
        guaranteedPassword.push(getRandom(specialChars));
      }
...
function writePassword() {
  ...
  passText.value = 'Your password is' + password + '!';
}
